                                ...
                                <div className='sort_Overview my-3'>
                                    <div className='container my-3'>
                                        <div className='row mx-3'>
                                            ...
                                            <div className='col-4 my-2 content-Overview ' style={{ backgroundColor: "#61dafb", cursor: "pointer" }}> Đơn thanh toán trực tiếp  </div>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        {item.receiveMoneyId === 3 &&
                                                                            < td >
                                                                                ...
                                                                                <span className='mb-3' style={{ color: "green", fontWeight: "600" }}  > Đã đối soát</span>
